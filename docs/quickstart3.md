---
title: Push Data from Local Device to VaultDB Hub
description: Learn to PUSH data to VaultDB HUB site from client in minutes.
...
weight: 20
toc: true
aliases: [/quickstart3/,/overview/quickstart3/]
pagination_next: quickstart4
pagination_prev: quickstart2
---
